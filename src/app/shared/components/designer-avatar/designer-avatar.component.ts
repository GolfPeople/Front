...
@Component({
  selector: 'app-designer-avatar',
  templateUrl: './designer-avatar.component.html',
  styleUrls: ['./designer-avatar.component.scss'],
})
export class DesignerAvatarComponent implements OnInit {
  // @Input() src;
